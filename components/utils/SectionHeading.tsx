...
const SectionHeading: FC<{
  ...
  return (
    <div className="section-heading relative overflow-hidden pb-14 text-center">
      ...
      <span
        ref={parallax.ref}
        className="pointer-events-none absolute -top-2 left-1/2 z-0 -translate-x-1/2 transform text-9xl font-bold uppercase text-heading opacity-5"
      >
        {watermark}
      </span>
    </div>
