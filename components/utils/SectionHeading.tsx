...
const SectionHeading:FC<{title: string, watermark: string, animated?: boolean}> = ({
  title,
  watermark,
  animated = true
}) => {
  ...
  return (
    <div className="section-heading relative overflow-hidden pb-14 text-center">
      ...
      <span className="relative z-10 inline-block h-1.5 w-32 overflow-hidden rounded-full bg-primary bg-opacity-20">
                <span
                  className="absolute left-0 top-0 inline-block h-full w-1.5 animate-lefttoright rounded-full bg-primary"></span>
            </span>
      <span
        ref={parallax.ref}
