    ...
    <div className="grid grid-cols-9 gap-7">
      ...
      >
        <div className="contact-information">
          <h4>Coordonnées</h4>
          <p>
            N'hesitez pas à me contacter de préférence par le formulaire de contact ou par mail pour des missions
            freelance ou pour toute demande de création de site.
          </p>
